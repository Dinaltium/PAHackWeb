  ...
  try {
    ...
    await pool.query(`
      ...
      VALUES 
        ...
        ('Library', 'LIB', 'Central library with study areas', '12.806105', '74.932041', 'academic', 'PA College of Engineering, Mangalore'),
        ('Student Hostel', 'HST', 'Student accommodation', '12.808123', '74.931837', 'residence', 'PA College of Engineering, Mangalore'),
